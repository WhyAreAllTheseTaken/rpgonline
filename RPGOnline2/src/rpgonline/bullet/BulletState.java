...
public abstract class BulletState extends BasicGameState implements BaseScaleState {
	 ...
	 * @see rpgonline.RPGConfig#setKeyInput(rpgonline.input.KeyboardInputProvider)
	 * @see rpgonline.RPGConfig#setControllerInput(rpgonline.input.ControllerInputProvider)
	 * @see rpgonline.input.InputUtils
	 * @see rpgonline.input.InputUtils#EXIT
	 */
	public void exit() {
